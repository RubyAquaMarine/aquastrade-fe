...
const isOperationPending = (operationState) =>
...
const isOperationSucceeded = (operationState) =>
...
const getBalance = (token, tokenBalance) =>
    ...
    <div className={"exchange"}>
      <Box className={"rounded filled background"}>
        <Stack spacing={2} direction="column" justifyContent="center">
          <FormGroup
            row={true}
            className={"rounded filled group centerContent"}
          >
          ...
          <FormHelperText id="outlined-weight-helper-text">
            {" "}
            {fromTokenBalance
              ? `Balance: ${getBalance(fromToken, fromTokenBalance)}`
              : ""}{" "}
          </FormHelperText>
          <FormGroup
            row={true}
          ...
          <FormHelperText id="outlined-weight-helper-text">
            {toTokenBalance
              ? `Balance: ${getBalance(toToken, toTokenBalance)}`
              : ""}
          </FormHelperText>
        </Stack>
